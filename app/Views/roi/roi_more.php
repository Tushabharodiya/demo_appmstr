                    ...
                    <div class="nk-block nk-block-lg">
                            ...
                            <div class="nk-block-between g-3">
                                <div class="nk-block-head-content">
                                    ...
                                    <div class="nk-block-des text-soft">
                                        <p><?php echo "You have total $moreRoiCount app rois."; ?></p>
                                    </div>
                                </div>
                                <div class="nk-block-head-content">
                                    <ul class="nk-block-tools g-3">
                                        <li>
                                            <form action="" method="post" class="form-validate is-alter" enctype="multipart/form-data">
                                                <div class="form-control-wrap">
                                                    ...
                                                    <input type="text" class="form-control" name="search_android_more_roi" value="<?php if(!empty($sessionAndroidMoreRoi)){ echo $sessionAndroidMoreRoi; } ?>" placeholder="Search by" autocomplete="off">
                                                </div>
                                        ...
                                        <li>
                                            <select class="form-control" id="search-status" name="search_android_more_roi_status" data-id="<?php echo $dataID;?>" data-placeholder="Select a status">
                                                <?php $str='';
                                                    if(!empty($sessionAndroidMoreRoiStatus == 'all')){
                                                        $str.='selected';
                                                } ?> <option value="all"<?php echo $str; ?>>All</option>
                                                <?php $str='';
                                                    if(!empty($sessionAndroidMoreRoiStatus == 'true')){
                                                        $str.='selected';
                                                } ?> <option value="true"<?php echo $str; ?>>True</option>
                                                <?php $str='';
                                                    if(!empty($sessionAndroidMoreRoiStatus == 'false')){
                                                        $str.='selected';
                                        ...
                                        <li>
                                            <form action="" method="post" class="form-validate is-alter" enctype="multipart/form-data">
                                                <div class="dropdown">
                                                    <a href="<?= !empty(session()->get('session_android_more_roi_previous_url')) ? session()->get('session_android_more_roi_previous_url') : base_url('more-roi/'.$dataID); ?>" class="dropdown-toggle btn btn-white btn-dim btn-outline-light" data-toggle="dropdown">
                                                            ...
                                                            <div class="row gx-6 gy-3">
                                                                <div class="col-6"> 
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-control-wrap">
                                                                            <input type="text" class="form-control date-picker" name="search_android_more_roi_start_date" value="<?php if(!empty($sessionAndroidMoreRoiStartDate)){ echo $sessionAndroidMoreRoiStartDate; } ?>"placeholder="Enter start date" autocomplete="off" data-date-format="yyyy-mm-dd" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-control-wrap">
                                                                            <input type="text" class="form-control date-picker" name="search_android_more_roi_end_date" value="<?php if(!empty($sessionAndroidMoreRoiEndDate)){ echo $sessionAndroidMoreRoiEndDate; } ?>"placeholder="Enter end date" autocomplete="off" data-date-format="yyyy-mm-dd" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                        ...
                                        <li>
                                            <a href="<?= !empty(session()->get('session_android_roi_view_previous_url')) ? session()->get('session_android_roi_view_previous_url') : base_url('view-roi/'.urlEncodes($appID)); ?>" class="btn btn-outline-light bg-white d-block d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="card card-bordered card-preview">
                            <table class="table table-tranx">
                                ...
                                <?php if(!empty($moreRoi)){ ?>
                                    <tbody>
                                        <?php foreach($moreRoi as $data){ ?>
                                                ...
                                                <div class="modal-dialog modal-dialog-top" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <a href="<?= !empty(session()->get('session_android_more_roi_previous_url')) ? session()->get('session_android_more_roi_previous_url') : base_url('more-roi/'.$dataID); ?>" class="close" data-dismiss="modal" aria-label="Close">
...
<script>
    document.getElementById('search-status').addEventListener('change', function() {
        ...
        $.ajax({
            url: '<?= base_url('more-roi'); ?>/' + dataID,
            type: 'POST',
            data: { search_android_more_roi_status: selectedStatus },
            success: function() {
                location.reload();
            }
        });
...
<script>
    function confirmDelete(dataId) {
        var confirmDelete = confirm("Are you sure you want to delete this roi?");

        if (confirmDelete) {
            window.location.href = "<?php echo base_url('delete-roi/'); ?>" + dataId;
        }
    }
</script>