                                    ...
                                    <div class="row g-gs">
                                        ...
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="email" class="form-control" name="developer_email" placeholder="Enter developer email" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    ...
                                                    <input type="text" class="form-control date-picker" name="developer_create_date" placeholder="Enter developer create date" autocomplete="off" data-date-format="dd-mm-yyyy" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="developer_device" placeholder="Enter developer device" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="developer_mac" placeholder="Enter developer mac" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="number" class="form-control" name="developer_mobile_number" placeholder="Enter developer mobile number" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="developer_identity_name" placeholder="Enter developer identity name" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="developer_identity_type" placeholder="Enter developer identity type" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <div class="custom-file">
                                                        <input type="file" class="form-control custom-file-input" name="developer_identity_front_file" required>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <div class="custom-file">
                                                        <input type="file" class="form-control custom-file-input" name="developer_identity_back_file" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="developer_payee_name" placeholder="Enter developer payee name" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="developer_payee_bank" placeholder="Enter developer payee bank" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="developer_payee_card" placeholder="Enter developer payee card" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
