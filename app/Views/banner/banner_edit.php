                                    ...
                                    <div class="row g-gs">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="banner_title" value="<?php echo $bannerData['banner_title'];?>" placeholder="Enter banner title" required>
                                                </div>
                                            </div>
                                        </div> 
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="banner_description" value="<?php echo $bannerData['banner_description'];?>" placeholder="Enter banner description" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <div class="custom-file">
                                                        <input type="file" class="form-control custom-file-input" id="file-uploader" name="banner_image" value="<?php echo $bannerData['banner_image'];?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="banner_url" value="<?php echo $bannerData['banner_url'];?>" placeholder="Enter banner url" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="banner_button" value="<?php echo $bannerData['banner_button'];?>" placeholder="Enter banner button" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap ">
                                                    <select class="form-control form-select" name="banner_type" data-placeholder="Select a type" required>
                                                        <option value="image"<?php echo ($bannerData['banner_type'] == 'image') ? 'selected' : '' ?>>Image</option>
                                                        <option value="text"<?php echo ($bannerData['banner_type'] == 'text') ? 'selected' : '' ?>>Text</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap ">
                                                    <select class="form-control form-select" name="banner_status" data-placeholder="Select a status" required>
                                                        <option value="true"<?php echo ($bannerData['banner_status'] == 'true') ? 'selected' : '' ?>>True</option>
                                                        <option value="false"<?php echo ($bannerData['banner_status'] == 'false') ? 'selected' : '' ?>>False</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-md btn-primary" id="submit-button">Update</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
