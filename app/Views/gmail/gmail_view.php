                            ...
                            <div class="nk-block-between g-3">
                                <div class="nk-block-head-content">
                                    ...
                                    <div class="nk-block-des text-soft">
                                        <p><?php echo "You have total $gmailCount gmails."; ?></p>
                                    </div>
                                </div>
                                <div class="nk-block-head-content">
                                    <ul class="nk-block-tools g-3">
                                        <li>
                                            <form action="" method="post" class="form-validate is-alter" enctype="multipart/form-data">
                                                <div class="form-control-wrap">
                                                    ...
                                                    <input type="text" class="form-control" name="search_account_gmail" value="<?php if(!empty($sessionAccountGmail)){ echo $sessionAccountGmail; } ?>" placeholder="Search by" autocomplete="off">
                                                </div>
                                        ...
                                        <li>
                                            <select class="form-control" id="search-status" name="search_account_gmail_status" data-placeholder="Select a status">
                                                <?php $str='';
                                                    if(!empty($sessionAccountGmailStatus == 'publish')){
                                                        $str.='selected';
                                                } ?> <option value="publish"<?php echo $str; ?>>Publish</option>
                                                <?php $str='';
                                                    if(!empty($sessionAccountGmailStatus == 'unpublish')){
                                                        $str.='selected';
                                                } ?> <option value="unpublish"<?php echo $str; ?>>Unpublish</option>
                                            </select>   
                                        </li>
                                        <li class="nk-block-tools-opt"><a href="<?php echo base_url('new-gmail');?>" class="btn btn-primary"><em class="icon ni ni-plus"></em></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                                            <ul class="link-list-plain">
                                                                ...
                                                                <li><a href="<?php echo base_url('info-gmail/'.urlEncodes($data['account_id']));?>">View</a></li>
                                                                <li><a href="<?php echo base_url('edit-gmail/'.urlEncodes($data['account_id']));?>">Edit</a></li>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <a href="<?= !empty(session()->get('session_account_gmail_view_previous_url')) ? session()->get('session_account_gmail_view_previous_url') : base_url('view-gmail'); ?>" class="close" data-dismiss="modal" aria-label="Close">
                                            ...
                                            <div class="modal fade" tabindex="-1" id="unpublishModal<?php echo urlEncodes($data['account_id']);?>">
                                                <div class="modal-dialog modal-dialog-top" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer bg-light">
                                                            <span class="sub-text"><a href="<?php echo base_url('gmail-status/'.urlEncodes($data['account_id']));?>" class="btn btn-sm btn-danger">Unpublish</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal fade" tabindex="-1" id="publishModal<?php echo urlEncodes($data['account_id']);?>">
                                                <div class="modal-dialog modal-dialog-top" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer bg-light">
                                                            <span class="sub-text"><a href="<?php echo base_url('gmail-status/'.urlEncodes($data['account_id']));?>" class="btn btn-sm btn-success">Publish</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    document.getElementById('search-status').addEventListener('change', function() {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: { search_account_gmail_status: selectedStatus },
            success: function() {
                location.reload();
            }
        });
