                            ...
                            <div class="nk-block-between g-3">
                                ...
                                <div class="nk-block-head-content">
                                    <div class="nk-block-head-sub">
                                        <span class="text-danger"><?php if(!empty(session('session_android_common_json_new'))){ ?> <?php echo session('session_android_common_json_new');?> <?php echo session()->remove('session_android_common_json_new');?> <?php } ?></span>
                                    </div>
                                </div>
                                <div class="nk-block-head-content">
                                ...
                                <div class="row gy-4">
                                    <?php if(!empty($viewBanner)){ ?>
                                        <?php foreach($viewBanner as $data){ ?>
                                            <div class="col-lg-4">
                                                <input type="checkbox" class="form-control plan-control" id="plan-iv-<?php echo $data['banner_id'];?>" name="data_json[]" value="<?php echo $data['banner_id']; ?>" required>
                                    ...
                                    <?php if(!empty($viewBanner)){ ?>
                                        <div class="col-lg-12">
                                            <button type="submit" class="btn btn-md btn-primary"><span>Save Informations</span></button>
                                        </div>
                                    <?php } ?>
                                </div>
                            </form>
